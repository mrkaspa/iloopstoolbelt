...
var (
	...
	ErrSSHNotDeleted              = errors.New("Could not delete the ssh")
	ErrSSHNotFound                = errors.New("Could not find the ssh")
	...
	ErrPasswordsUnMatch           = errors.New("The passwords are different")
)
